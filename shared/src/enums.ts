...
> = Object.freeze({
  pending_verification: ['quarantined', 'available', 'defective', 'written_off', 'purchase_returned'],
  quarantined: ['available', 'defective', 'written_off', 'purchase_returned', 'pending_verification'],
  available: ['reserved', 'sold', 'defective', 'repair', 'written_off', 'quarantined', 'purchase_returned'],
  reserved: ['available', 'sold', 'defective', 'quarantined'],
  sold: ['returned_inspection'],
  returned_inspection: ['available', 'defective', 'supplier_warranty', 'repair', 'written_off', 'quarantined'],
  defective: ['supplier_warranty', 'repair', 'written_off', 'purchase_returned', 'returned_inspection'],
  supplier_warranty: ['available', 'defective', 'written_off', 'purchase_returned', 'repair'],
  customer_warranty: ['repair', 'defective', 'available', 'written_off'],
  repair: ['available', 'defective', 'written_off', 'customer_warranty', 'returned_inspection'],
  written_off: [],
  purchase_returned: [],
});

/** States in which a unit may be added to a cart and sold. */
export const SALEABLE_STOCK_STATES: readonly SerializedStockState[] = ['available'];
 ...
 */
export const MOVEMENT_ON_HAND_SIGN: Readonly<Record<MovementType, -1 | 0 | 1>> = Object.freeze({
  purchase_receive: 1,
  sale: -1,
  sale_return: 1,
  purchase_return: -1,
...
export const PRODUCT_CONDITIONS = ['new', 'used', 'open_box', 'refurbished'] as const;
...
export const SALE_STATUSES = ['draft', 'posted', 'cancelled', 'partially_returned', 'returned'] as const;
export type SaleStatus = (typeof SALE_STATUSES)[number];

export const PAYMENT_METHODS = ['cash', 'bank_transfer', 'card', 'digital_wallet', 'credit'] as const;
...
export const DEMAND_URGENCIES = ['immediate', 'within_week', 'within_month', 'flexible'] as const;
export type DemandUrgency = (typeof DEMAND_URGENCIES)[number];

export const DEMAND_CHANNELS = ['walk_in', 'phone', 'whatsapp', 'referral', 'other'] as const;
...
export const EXTERNAL_DIRECTION_BY_SERVICE_TYPE: Readonly<Record<ExternalServiceType, string>> =
  Object.freeze({
    send: 'SENT_FROM_SHOP',
...
export const EXTERNAL_REVENUE_STATUSES: readonly ExternalTransactionStatus[] = ['successful'];
...
export type RecommendationDecisionType = (typeof RECOMMENDATION_DECISIONS)[number];

...
export const ALL_PERMISSIONS: readonly PermissionKey[] = Object.freeze(Object.values(PERMISSIONS));
 ...
 */
export const DEFAULT_ROLE_PERMISSIONS: Readonly<Record<RoleCode, readonly PermissionKey[]>> =
  Object.freeze({
    ...
    [ROLES.MANAGER]: Object.freeze([
      P.USERS_VIEW,
      P.ROLES_VIEW,
      P.CATALOG_VIEW, P.CATALOG_CREATE, P.CATALOG_UPDATE, P.CATALOG_DEACTIVATE, P.CATALOG_VIEW_COST,
      P.PRICING_VIEW, P.PRICING_MANAGE,
      P.INVENTORY_VIEW, P.INVENTORY_VIEW_COST, P.INVENTORY_ADJUST, P.INVENTORY_APPROVE_ADJUSTMENT,
      P.INVENTORY_COUNT, P.INVENTORY_TRANSFER, P.INVENTORY_RESERVE,
      P.SUPPLIERS_VIEW, P.SUPPLIERS_MANAGE,
      P.PURCHASES_VIEW, P.PURCHASES_CREATE, P.PURCHASES_APPROVE, P.PURCHASES_RECEIVE, P.PURCHASES_RETURN,
      P.CUSTOMERS_VIEW, P.CUSTOMERS_MANAGE,
      P.DEMAND_VIEW, P.DEMAND_CREATE, P.DEMAND_MANAGE,
      P.SALES_VIEW, P.SALES_CREATE, P.SALES_POST, P.SALES_VIEW_PROFIT, P.SALES_DISCOUNT,
      P.SALES_DISCOUNT_OVERRIDE, P.SALES_CREDIT,
      P.PAYMENTS_COLLECT,
      P.RETURNS_VIEW, P.RETURNS_CREATE, P.RETURNS_APPROVE,
      P.EXTERNAL_SERVICES_VIEW, P.EXTERNAL_SERVICES_RECORD, P.EXTERNAL_FEE_RULES_VIEW,
      P.CASH_SESSIONS_VIEW, P.CASH_SESSIONS_OPEN, P.CASH_SESSIONS_CLOSE, P.CASH_SESSIONS_REVIEW,
      P.EXPENSES_VIEW, P.EXPENSES_CREATE, P.EXPENSES_APPROVE,
      P.RECEIVABLES_VIEW, P.RECEIVABLES_MANAGE, P.PAYABLES_VIEW, P.PAYABLES_MANAGE,
      P.REPORTS_VIEW, P.REPORTS_VIEW_FINANCIAL, P.REPORTS_EXPORT,
    ...
    [ROLES.SALESPERSON]: Object.freeze([
      ...
      P.CUSTOMERS_VIEW, P.CUSTOMERS_MANAGE,
      P.DEMAND_VIEW, P.DEMAND_CREATE, P.DEMAND_MANAGE,
      P.SALES_VIEW, P.SALES_CREATE, P.SALES_POST, P.SALES_DISCOUNT,
      P.RETURNS_VIEW,
      P.EXTERNAL_SERVICES_VIEW, P.EXTERNAL_SERVICES_RECORD,
    ]),
    ...
    [ROLES.CASHIER]: Object.freeze([
      ...
      P.CUSTOMERS_VIEW, P.CUSTOMERS_MANAGE,
      P.DEMAND_CREATE,
      P.SALES_VIEW, P.SALES_CREATE, P.SALES_POST,
      P.PAYMENTS_COLLECT,
      P.RETURNS_VIEW, P.RETURNS_CREATE,
      P.EXTERNAL_SERVICES_VIEW, P.EXTERNAL_SERVICES_RECORD,
      P.CASH_SESSIONS_VIEW, P.CASH_SESSIONS_OPEN, P.CASH_SESSIONS_CLOSE,
      P.EXPENSES_VIEW, P.EXPENSES_CREATE,
    ]),

    [ROLES.PURCHASER]: Object.freeze([
      P.CATALOG_VIEW, P.CATALOG_CREATE, P.CATALOG_UPDATE, P.CATALOG_VIEW_COST,
      P.PRICING_VIEW,
      P.INVENTORY_VIEW, P.INVENTORY_VIEW_COST, P.INVENTORY_ADJUST, P.INVENTORY_COUNT,
      P.INVENTORY_TRANSFER,
      P.SUPPLIERS_VIEW, P.SUPPLIERS_MANAGE,
      P.PURCHASES_VIEW, P.PURCHASES_CREATE, P.PURCHASES_RECEIVE, P.PURCHASES_RETURN,
      P.DEMAND_VIEW,
      P.PAYABLES_VIEW,
      P.REPORTS_VIEW,
      P.RECOMMENDATIONS_VIEW,
    ...
    [ROLES.ACCOUNTANT]: Object.freeze([
      P.CATALOG_VIEW, P.CATALOG_VIEW_COST,
      P.INVENTORY_VIEW, P.INVENTORY_VIEW_COST,
      P.SUPPLIERS_VIEW,
      P.PURCHASES_VIEW,
      P.CUSTOMERS_VIEW,
      P.SALES_VIEW, P.SALES_VIEW_PROFIT,
      P.RETURNS_VIEW,
      P.EXTERNAL_SERVICES_VIEW, P.EXTERNAL_FEE_RULES_VIEW,
      P.CASH_SESSIONS_VIEW,
      P.EXPENSES_VIEW, P.EXPENSES_CREATE,
      P.RECEIVABLES_VIEW, P.PAYABLES_VIEW, P.LEDGER_VIEW,
      P.REPORTS_VIEW, P.REPORTS_VIEW_FINANCIAL, P.REPORTS_EXPORT,
    ]),

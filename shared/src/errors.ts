...
export const ERROR_CODES = {
  ...
  EXTERNAL_TRANSACTION_POSTED_IMMUTABLE: 'EXTERNAL_TRANSACTION_POSTED_IMMUTABLE',
  ...
  CASH_SESSION_VARIANCE_REASON_REQUIRED: 'CASH_SESSION_VARIANCE_REASON_REQUIRED',
...
export class DomainError extends Error {
  ...
  constructor(
    code: ErrorCode,
    message: string,
    options: { status?: number; details?: Record<string, readonly string[]>; cause?: unknown } = {},
  ) {
...
export const DEFAULT_ERROR_STATUS: Partial<Record<ErrorCode, number>> = Object.freeze({

...
export default function WorkspaceError({ error, reset }: WorkspaceErrorProps) {
  return (
    <section
      className="mx-auto max-w-2xl overflow-hidden rounded-card border border-negative/25 bg-surface shadow-card"
      role="alert"
    >
      <div className="flex items-start gap-3 p-5">
        ...
        <div>
          ...
          <p className="mt-1 text-[0.8125rem] text-ink-subtle">
            The failure was contained. Retry the screen; if it repeats, use the
            reference below to find the corresponding server log.
          </p>
